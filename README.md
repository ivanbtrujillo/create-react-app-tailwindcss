...
This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app) enhanced with the integration of [TailwindCSS](https://tailwindcss.com/)
